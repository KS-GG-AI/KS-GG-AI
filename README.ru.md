...
<img src="./assets/project-map.svg?v=40072f63a900" alt="Карта проектов с рабочим пространством KS-GG-AI, публичными проектами и намеренно скрытой приватной работой." width="480" />
...
<details>
<summary><strong>Посмотреть визуальную техническую карту</strong></summary>
