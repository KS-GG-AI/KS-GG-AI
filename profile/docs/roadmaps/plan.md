...
| [x] | TODO-05 | 정기·수동 자동화와 공통 경쟁 제어를 추가한다. | `.github/workflows/refresh-roadmaps.yml` | 변경 시에만 allowlist 파일을 커밋하고 동시 README 갱신이 직렬화된다. | TODO-02, TODO-03, TODO-04 | REQ-07, REQ-08 |
...
- `npm ci --prefix profile/automation/roadmaps --ignore-scripts`, `npm run --prefix profile/automation/roadmaps roadmaps:test`, `npm audit --prefix profile/automation/roadmaps --omit=dev --audit-level=high`를 통과했다.
